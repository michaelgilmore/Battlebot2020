...
void loop()
{
  ...
  ********************************/
  ...
  if(distInCentimeters <= 4 && distInCentimeters > 0){
    if(spunRightLastTime)
    {
      spinLeft();
      delay(2000);
      spunRightLastTime = false;
    ...
    else
    {
      spinRight();
      delay(2000);
      spunRightLastTime = true;
    }
  }
  else {
    if(distInCentimeters>12)
    {
      goForwardSlow();
    }
    else
